...
const HeartRateChart: React.FC<HeartRateChartProps> = ({ data, chartConfig }) => {
      ...
      <CardContent>
        <ChartContainer config={chartConfig} className="h-[250px] w-full">
          <LineChart data={data} margin={{ top: 5, right: 20, left: -10, bottom: 5 }}>
            ...
            <ChartTooltip 
              content={<ChartTooltipContent nameKey="name" labelFormatter={(value) => format(new Date(value), 'MMM d, HH:mm')} />} 
            />
